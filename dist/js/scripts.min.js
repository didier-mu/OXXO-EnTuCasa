function getCookie(o){for(var n=o+"=",e=decodeURIComponent(document.cookie),a=e.split(";"),t=0;t<a.length;t++){for(var l=a[t];" "==l.charAt(0);)l=l.substring(1);if(0==l.indexOf(n))return l.substring(n.length,l.length)}return""}function dato(){$.ajax({url:"/ws/PromocionCupon/getCoupons",type:"GET",success:function(o){if(1==o.estatus){var n=JSON.parse(o.data);n[0]?(prm=!0,$(".linkredfb").attr("href","/cuponera/facebook/"+n[0].id_cupon),$(".linkred").attr("href","/cuponera/google/"+n[0].id_cupon),$(".cuponEsp").attr("src",n[0].imagen_cupon)):prm=!1}}})}$(document).ready(function(){function o(){function o(){window.jQuery?1==$("#logout_btn").length?1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/d79b2f692c44897e27b8f1a93fe7b10c",window.location.href=linkfinal}):$(".linkCupon").on("click",function(){$(".modal-felicidades").hide(1),$(".linkContinuar").show(1),$(".linkredfb").hide(1),$(".linkred").hide(1),$(".modal-sesion").show(1)}):$(".linkCupon").on("click",function(){$(".modal-felicidades").hide(1),$(".linkContinuar").hide(1),$(".linkredfb").show(1),$(".linkred").show(1),$(".modal-sesion").show(1)}):setTimeout(function(){o()},2)}$("#ala").addClass("giroActivo");var e=Math.floor(30*Math.random()+2);1==prm&&(e=1),console.log(e),$("#botonGirar").off();o();setTimeout(function(){switch(e){case 1:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/aa573d1a63edfa3eda0a62cd975bf62a.jpg"),n="/1",setTimeout(function(){$("#modalCupon").modal("show")},5500);break;case 2:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/cfb2c063828d29ab0e856db71c490846.jpg"),urlCuponFb="/promoxxo/getcoupon/1e951a3dcc7fb5a3a14ab4a7db7815c6",urlCuponGl="/promoxxo/getcoupon/1e951a3dcc7fb5a3a14ab4a7db7815c6",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/d79b2f692c44897e27b8f1a93fe7b10c",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5500);break;case 3:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/b3f92710ad3f345f507ce017ad5111e3.jpg"),urlCuponFb="/promoxxo/getcoupon/6aae7f06169d711d86d8a0d22660d9b4",urlCuponGl="/promoxxo/getcoupon/6aae7f06169d711d86d8a0d22660d9b4",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/fb34e238cfcf702b6380a43dd7cb308e",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 4:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/392d5194feb114dc903610035681bc5a.jpg"),urlCuponFb="/promoxxo/getcoupon/d9f29f45e144cd0cd5f13e37bb17f8ca",urlCuponGl="/promoxxo/getcoupon/d9f29f45e144cd0cd5f13e37bb17f8ca",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/d9f29f45e144cd0cd5f13e37bb17f8ca",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 5:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/3e7d6281de939745404e1c1c01c9cc24.jpg"),urlCuponFb="/promoxxo/getcoupon/c708dfdc2d89bf37995deb3b6061cc7e",urlCuponGl="/promoxxo/getcoupon/c708dfdc2d89bf37995deb3b6061cc7e",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/c708dfdc2d89bf37995deb3b6061cc7e",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 6:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/3f4a02177012ac7349f4b50f573f89e8.jpg"),urlCuponFb="/promoxxo/getcoupon/c17fbe52357bedb7830eeee804b4dd4b",urlCuponGl="/promoxxo/getcoupon/c17fbe52357bedb7830eeee804b4dd4b",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/c17fbe52357bedb7830eeee804b4dd4b",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 7:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/"),urlCuponFb="/promoxxo/getcoupon/",urlCuponGl="/promoxxo/getcoupon/",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 8:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/ec417b543e0bca2211d379d76e7fa606.jpg"),urlCuponFb="/promoxxo/getcoupon/4eb952bdc5b7be49bb9e9cef8e547086",urlCuponGl="/promoxxo/getcoupon/4eb952bdc5b7be49bb9e9cef8e547086",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/4eb952bdc5b7be49bb9e9cef8e547086",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 9:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/b3f92710ad3f345f507ce017ad5111e3.jpg"),urlCuponFb="/promoxxo/getcoupon/6aae7f06169d711d86d8a0d22660d9b4",urlCuponGl="/promoxxo/getcoupon/6aae7f06169d711d86d8a0d22660d9b4",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/fb34e238cfcf702b6380a43dd7cb308e",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 10:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/73d875ce3981ffbfd190d116f901f00e.jpg"),urlCuponFb="/promoxxo/getcoupon/e8f990b1f0e8e4e84e80b8383ca211c8",urlCuponGl="/promoxxo/getcoupon/e8f990b1f0e8e4e84e80b8383ca211c8",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/e8f990b1f0e8e4e84e80b8383ca211c8",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 11:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/b5fb91bed26a7151f7faeff07565d17d.jpg"),urlCuponFb="/promoxxo/getcoupon/0eb7ec646d2b2bb89760732a69eb6020",urlCuponGl="/promoxxo/getcoupon/0eb7ec646d2b2bb89760732a69eb6020",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/0eb7ec646d2b2bb89760732a69eb6020",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 12:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/8b31734354f3b86aec071c005144cbb4.jpg"),urlCuponFb="/promoxxo/getcoupon/76b63971032dcfa0e44b38dd2755bc18",urlCuponGl="/promoxxo/getcoupon/76b63971032dcfa0e44b38dd2755bc18",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/76b63971032dcfa0e44b38dd2755bc18",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 13:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/"),urlCuponFb="/promoxxo/getcoupon/",urlCuponGl="/promoxxo/getcoupon/",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 14:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/"),urlCuponFb="/promoxxo/getcoupon/",urlCuponGl="/promoxxo/getcoupon/",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/fb34e238cfcf702b6380a43dd7cb308e",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;case 15:$("#ala").addClass("giro4"),$("#cupon").attr("src","https://oxxo-com.s3.amazonaws.com/cupones/"),urlCuponFb="/promoxxo/getcoupon/",urlCuponGl="/promoxxo/getcoupon/",console.log(n),$(".LinkCuponNormalFb").attr("href",urlCuponFb),$(".LinkCuponNormalGl").attr("href",urlCuponGl),1==$("#logout_btn").length&&(1==getCookie("feria")?$(".linkCupon").on("click",function(){linkfinal="/promoxxo/getcoupon/",window.location.href=linkfinal}):$(".linkContinuar").attr("href",n)),setTimeout(function(){$("#modalCupon").modal("show")},5e3);break;default:$("#ala").addClass("giro1"),setTimeout(function(){$("#modalDefault").modal("show")},5500)}},0)}$("html").css("opacity","1"),$("#modalCupon").modal().show,$(".botonera a").on("click",function(o){0==$(this).parents(".cajaSesion").find(".checkL").prop("checked")?($(".msjError").remove(),$(".cajaL").append('<span class="msjError"> Debes aceptar los términos y condiciones. </span>'),o.preventDefault()):0==$(this).parents(".cajaSesion").find(".checkE").prop("checked")?($(".msjError").remove(),$(".cajaEdad").append('<span class="msjError"> Debes ser mayor de 18 años </span>'),o.preventDefault()):($(".cajaL .msjError").remove(),$(".cajaEdad .msjError").remove(),document.cookie="feria=1"),$(".cajaSesion .error-input").length}),$(".checkmark").on("click",function(){0==$(this).siblings("input").prop("checked")?($(".msjError").remove(),$(this).siblings("input").attr("checked","checked")):$(this).siblings("input").removeAttr("checked")});var n;$("#botonGirar").on("click",function(){o()}),$("#modalDefault .btnOn, .closeModal").on("click",function(){$("#ala").attr("class","img-fluid"),$("#botonGirar").on("click",o)}),$("#ObtCupon").click(function(){$("#mycupon").attr("value",1)}),$("#formCupon").submit(function(){console.log("entro")})}),$(function(){dato()});var prm=!1;
